          ...
          child: Column(
            ...
            children: [
              ...
              if (widget.task.subtasks!.isNotEmpty) ...[
                ...
                ...widget.task.subtasks!.map((subtask) => CheckboxListTile(
                      title: Text(subtask.title),
                      value: subtask.isCompleted,
                      onChanged: (value) {
                        taskProvider.toggleSubtaskCompletion(widget.task.id,
                            widget.task.subtasks!.indexOf(subtask));
                      },
                      secondary: IconButton(
                        icon: const Icon(Icons.delete, color: Colors.red),
                        onPressed: () {
                          taskProvider.removeSubtask(widget.task.id,
                              widget.task.subtasks!.indexOf(subtask));
                        },
                      ),
                    )),
